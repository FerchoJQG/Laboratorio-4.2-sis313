...
> ![Captura de pantalla: Configuración de red en la VM Web y comando netplan apply](imagen/imagen5.png)
> ![Captura de pantalla: Configuración de red en la VM Web y comando netplan apply](imagen/imagen6.png)
...
> ![Captura de pantalla: Resultados de dig y nslookup desde la VM Cliente](imagen/imagen26.png)
> ![Captura de pantalla: Resultados de dig y nslookup desde la VM Cliente](imagen/imagen27.png)
...
> ![Captura de pantalla: Respuesta del comando curl mostrando el HTML de bienvenida](imagen/imagen28_1.png)
---
...
> ![Captura de pantalla: Edición del archivo hosts con el mapeo del dominio a 127.0.0.1](imagen/imagen29_1.png)
...
> ![Captura de pantalla completa: Navegador web mostrando la página de bienvenida de lab42.local](imagen/imagen30.png)
---
...
> ![Captura de VirtualBox mostrando la configuración del Adaptador 1 en modo Puente](imagen/imagen31.png)
---
...
> ![Captura editando el archivo named.conf.local con el nuevo dominio elegido](imagen/imagen32.png)
...
> ![Captura de la terminal con el comando ip a mostrando la IP física asignada en modo Puente](imagen/imagen33.png)
...
> ![Captura del archivo de zona directa db.[dominio] con los registros A y CNAME configurados](imagen/imagen34.png)
...
> ![Captura de la edición de named.conf.local y del archivo de zona inversa db.192.168.x](imagen/imagen35.png)
...
> ![Captura de la verificación exitosa de las zonas (OK) y reinicio del servicio BIND9](imagen/imagen36.png)
